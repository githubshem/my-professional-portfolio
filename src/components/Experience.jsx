...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      responsibilities: [
        'Ensured flawless functionality of our platforms across diverse viewports, including mobile, web, tablet, and iOS applications. Played a pivotal role in meeting stakeholder requests by rigorously testing and validating all functionalities.',
        'Fostered a culture of teamwork and synergy by collaborating with cross-functional teams, including front-end and back-end developers, UI/UX designers, QA professionals, and project managers. While having a DevOps culture, this enabled successful project delivery by working closely with each other.',
        'Worked in an Agile environment with bi-weekly sprints',
        'Efficiently monitored and ensured the quality of hotfix deployments by maintaining view access on Bitbucket and observing pipelines executed by our Technology Director and his team. Supported agile and timely development.',
      ],
    },
    {
