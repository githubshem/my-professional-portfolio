  ...
  const experiences = [
    {
      ...
      responsibilities: [
        ...
        'Executed production deployments for version releases of the Common Use Self-Service (CUSS) platform, Self-Service Bag Drops (SSBD), and Passenger Reconciliation System (PRS) ensuring high availability and minimal service disruption across international airport environments.',
